                ...
                <div id="items-added">
                    ...
                    <div class="leftside">
                        <div class="item-view">
                            ...
                            <input type="image" name="DELETE" id="delete-icon" src="images/delete-icon.png" alt="delete">
                        </div>
                    ...
                    <div class="rightside">
                        ...
                        <a href="employee.php"><input type="button" id="delbutton" value="Delete Order" name="DELETE"></a>
                        <a href="employee.php"><input type="button" id="button" value="Save" name="UPDATE"></a>
                    </div>
                </div>
            </form>
        <!-- FOOTER -->
